...
const TaskDetails = () => {
    ...
    if (!data) {
        return (
            ...
            <div className="text-2xl font-semibold text-red-600 mb-2">Task not found</div>
            <div className="text-gray-500 mb-4">The task you are looking for does not exist or has been removed.</div>
            <button
