...
import { useAddTaskMutation } from "@/hooks/use-task";
...
import type { ProjectMemberRole, User } from "@/schema";
...
export type addTaskData = z.infer<typeof taskSchema>;
...
export const AddTaskPopUp = ({
    ...
    const form = useForm<addTaskData>({
    ...
    const onSubmit = (values: addTaskData) => {
        mutate(
        {
            projectId,
            taskData: values,
